...
This is similar to tic_tac_toe.py but all relevent moves are parameterized by board_size arg that sets how big
...
if __name__ == '__main__':
    ...
    play_game(random_player, random_player, log=True, board_size=5, winning_length=4) # Change the board_size here to whatever value you need.
